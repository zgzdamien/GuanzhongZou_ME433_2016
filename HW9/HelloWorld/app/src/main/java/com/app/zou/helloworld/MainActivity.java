package com.app.zou.helloworld;
...
public class MainActivity extends Activity implements TextureView.SurfaceTextureListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paint1.setColor(0xffffff00); // red
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        ...
        if (c != null) {
            ...
            for (int i = 0; i < bmp.getWidth(); i++) {
                ...
                if(red(pixels[i])>100 && green(pixels[i])<150 && blue(pixels[i])<150)
                //if(!(green(pixels[i])>150))//not green
                {
            ...
            canvas.drawCircle(COM[0], startY, 5, paint1);
            canvas.drawCircle(COM[1], startY1, 5, paint1);
            canvas.drawCircle(COM[2], startY2, 5, paint1);

            // also write the value as text
            canvas.drawText("COM[0] = " + COM[0], 10, 200, paint1);
